...
size, scale = 40, 2
ageData = df["Age"]
# bins = np.arange(min(ageData), max(ageData) + 1, 1)
# plt.hist(df['Age'], bins)
# plt = ageData.plot(kind='hist')
...
plt.bar_label(bars, fontsize=30, color='black')
...
print(answerFreqArray)
freqLabels = ['q1', 'q2', 'q3', 'q4', 'q5', 'q6', 'q7', 'q8', 'q9', 'q10']
# plt.pie(answerFreqArray, labels=freqLabels)
# plt.show()
...
# Adding a title
plt.title = ("Autism Gender Distribution")
